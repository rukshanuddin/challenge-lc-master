    ...
    return (
      <div style={{ align: "center" }}>
        <Paper elevation={24} square={true}>
          <GridList cellHeight={250} className="ReactJSList">
            <GridListTile
              key="Subheader"
              cols={2}
...
const mapStateToProps = (state) => ({
  links: state.ReactJS.models,

  loading: state.ReactJS.loading,
});
