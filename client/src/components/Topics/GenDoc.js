...
class GenDoc extends Component {
  static propTypes = {
    fetchGenDoc: PropTypes.func,
    ...
    return (
      <div style={{ align: "center" }}>
        <Paper elevation={24} square={true}>
          <GridList cellHeight={250} className="GenDocList">
            <GridListTile
              key="Subheader"
              cols={2}
...
const mapStateToProps = (state) => ({
  links: state.GenDoc.models,

  loading: state.GenDoc.loading,
});
