    ...
    return (
      <div style={{ align: "center" }}>
        <Paper elevation={24} square={true}>
          <GridList cellHeight={250} className="RailsAPIList">
            <GridListTile
              key="Subheader"
              cols={2}
...
const mapStateToProps = (state) => ({
  links: state.RailsAPI.models,

  loading: state.RailsAPI.loading,
});
