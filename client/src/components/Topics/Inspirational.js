...
class Inspirational extends Component {
  static propTypes = {
    fetchInspirational: PropTypes.func,
    ...
    return (
      <div style={{ align: "center" }}>
        <Paper elevation={24} square={true}>
          <GridList cellHeight={250} className="InspirationalList">
            <GridListTile
              key="Subheader"
              cols={2}
...
const mapStateToProps = (state) => ({
  links: state.Inspirational.models,

  loading: state.Inspirational.loading,
});
