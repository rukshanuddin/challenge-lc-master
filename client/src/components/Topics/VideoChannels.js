...
class VideoChannels extends Component {
  static propTypes = {
    fetchVideoChannels: PropTypes.func,
    ...
    return (
      <div style={{ align: "center" }}>
        <Paper elevation={24} square={true}>
          <GridList cellHeight={250} className="VideoChannelsList">
            <GridListTile
              key="Subheader"
              cols={2}
...
const mapStateToProps = (state) => ({
  links: state.VideoChannels.models,

  loading: state.VideoChannels.loading,
});
